...
// #define FLAGS_logtostderr imu_an_logtostderr
// #define FLAGS_alsologtostderr imu_an_alsologtostderr
// #define FLAGS_colorlogtostderr imu_an_colorlogtostderr
                ...
                const std::vector<double>& gyro_d_z)
{
    ...
    for (long unsigned int index = 0; index < gyro_ts_x.size(); ++index)
    {
        out_t << gyro_ts_x[index] << '\n';
